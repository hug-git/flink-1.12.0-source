...
abstract class AbstractYarnCli extends AbstractCustomCommandLine {
	...
	public boolean isActive(CommandLine commandLine) {
		/*TODO addressOption.getOpt()="m" 获取-m 后面的第一个值*/
		final String jobManagerOption = commandLine.getOptionValue(addressOption.getOpt(), null);
		/*TODO ID是固定的字符串 "yarn-cluster" | 是否指定为per-job模式，即指定”-m yarn-cluster”; ID = "yarn-cluster"*/
		final boolean yarnJobManager = ID.equals(jobManagerOption);
		/*TODO 判断是否存在 Yarn Session对应的 AppID | 即yarn-session模式是否启动*/
